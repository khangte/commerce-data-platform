...
> 상태: Reference
> 기준 문서: [PRD v1.8](../../PRD_v1.8.md), [Phase 3](../phases/phase-03-incremental-ingestion.md), [Phase 4](../phases/phase-04-airflow-orchestration.md), [Phase 5](../phases/phase-05-dbt-duckdb-modeling.md)
...
- [PRD v1.8](../../PRD_v1.8.md) — Section 7.1 상태 Mapping, Section 14 dbt Model, Section 15 SCD2
