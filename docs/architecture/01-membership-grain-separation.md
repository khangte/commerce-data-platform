...
> 상태: Implemented
> 작성일: 2026-09-09
> 관련 문서: [PRD v1.11](../../PRD_v1.11.md), [데이터 변환 흐름](../reference/data-transformation-flow.md), [Phase 6](../phases/phase-06-dimensional-modeling.md)
...
| 문서                                       | 수정 내용                                                              |
| ------------------------------------------ | ---------------------------------------------------------------------- |
| `PRD_v1.11.md`                               | Section 7.5, 14.1, 15, Source Table 목록(6→7), AC-19                    |
