...
Version 1.0은 기능 범위를 확장하기보다 **2026-09-03 기준 기술 버전, 배포 방식, 재현성**을 다시 검토해 Baseline을 정리한 버전이다.
...
- SeaweedFS Community Edition의 현재 배포/유지보수 정책을 재검토하여 Local S3-compatible Object Storage를 **SeaweedFS 4.45**로 변경
...
`dbt-duckdb 1.11.0`은 dbt-core 1.8 이상과 DuckDB 1.0 이상을 지원 범위로 두므로 다음 조합을 v1.0 Baseline으로 사용한다.
