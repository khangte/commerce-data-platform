...
from src.ingestion.bronze import BronzeWriteContext, TableBronzeWriter, table_logical_hash
from src.ingestion.extract import SourceRecord
from src.ingestion.tables import ORDER_PAYMENTS_TABLE


def test_table_bronze_writer_supports_non_orders_decimal_table_and_stable_logical_hash(tmp_path) -> None:
