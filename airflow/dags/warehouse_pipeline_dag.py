...
from src.ingestion.verification import BronzeCommitVerificationError, verify_bronze_commit
...
with DAG(
    ...
    def acquire_source_snapshot_lease(run_info: dict) -> dict:
        ...
        owner_id = uuid.uuid4()
        lease = acquire_source_mutation_lease(settings, owner_type=WAREHOUSE_OWNER_TYPE, owner_id=owner_id)
    ...
    def verify_bronze_commit_task(run_info: dict, extract_results: list) -> dict:
        ...
        except BronzeCommitVerificationError as error:
